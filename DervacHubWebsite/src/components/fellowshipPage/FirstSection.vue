...
<template>
    <div class="flex lg:flex-row relative flex-col text-center lg:text-left gap-y-0 gap-8 bg-gradient-to-tl from-[#f2f6fb] to-[#f3e0e5] py-8 md:pb-36 md:pt-16 md:px-24 px-8 items-center font-sans">
        <div class="flex flex-col gap-8 w-[90%]">
        ...
        <div class="lg:w-full">
            ...
            <img src="./images/blue-curve.svg" alt="" class="absolute right-0 hidden lg:block lg:top-20 w-[500px] lg:h-[500px]">
        </div>
        <div class="md:hidden">
