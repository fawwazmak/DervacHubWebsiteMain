...
<template>
    <div class="flex flex-col gap-10 mt-16 md:px-24 px-8">
        ...
        <div class="grid grid-cols-5 w-[85%] mx-auto items-center gap-12">
            ...
            <img class="" src="./images/tech-crunch.svg" alt="">
            <img class="" src="./images/bloommerg-logo.svg" alt="">
            <img class="" src="./images/gizmodo-logo.svg" alt="">
            <img class="" src="./images/forbes-logo.svg" alt="">
        </div>
    </div>
</template>