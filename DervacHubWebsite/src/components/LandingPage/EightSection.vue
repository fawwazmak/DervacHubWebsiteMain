    ...
    <div class="md:w-[50%] md:px-0 px-6 md:mx-auto py-16 flex flex-col gap-12">
        ...
        <div>
            <div class="flex gap-6 p-6">
                ...
                <div class="flex w-fit h-fit" @click="() => this.showFaqsAnswerOne = !this.showFaqsAnswerOne">
                    <img src="./images/plus-icon-gray-color.svg" v-if="!showFaqsAnswerOne" alt="">
            ...
            <div class="flex gap-6 p-6">
                ...
                <div class="flex w-fit h-fit" @click="() => this.showFaqsAnswerTwo = !this.showFaqsAnswerTwo">
                    <img src="./images/plus-icon-gray-color.svg" v-if="!showFaqsAnswerTwo" alt="">
                    <img src="./images/minus-icon-gray-color.svg" v-else alt="">
                </div>
            ...
            <div class="flex gap-6 p-6">
                ...
                <div class="flex w-fit h-fit" @click="() => this.showFaqsAnswerThree = !this.showFaqsAnswerThree">
                    <img src="./images/plus-icon-gray-color.svg" v-if="!showFaqsAnswerThree" alt="">
                    <img src="./images/minus-icon-gray-color.svg" v-else alt="">
                </div>
            ...
            <div class="flex gap-6 p-6">
                ...
                <div class="flex w-fit h-fit" @click="() => this.showFaqsAnswerFour = !this.showFaqsAnswerFour">
                    <img src="./images/plus-icon-gray-color.svg" v-if="!showFaqsAnswerFour" alt="">
                    <img src="./images/minus-icon-gray-color.svg" v-else alt="">
                </div>
            ...
            <div class="flex gap-6 p-6">
                ...
                <div class="flex w-fit h-fit" @click="() => this.showFaqsAnswerFive = !this.showFaqsAnswerFive">
                    <img src="./images/plus-icon-gray-color.svg" v-if="!showFaqsAnswerFive" alt="">
                    <img src="./images/minus-icon-gray-color.svg" v-else alt="">
                </div>
            ...
            <div class="flex gap-6 p-6">
                ...
                <div class="flex w-fit h-fit" @click="() => this.showFaqsAnswerSix = !this.showFaqsAnswerSix">
                    <img src="./images/plus-icon-gray-color.svg" v-if="!showFaqsAnswerSix" alt="">
                    <img src="./images/minus-icon-gray-color.svg" v-else alt="">
                </div>
