<template>
    <div class="w-full bg-white h-fit lg:p-[3rem] sm:p-[2rem] md:p-[1rem] flex flex-col gap-[4rem] sm:items-center items-start  sm:text-center md:text-start">
        <div class="flex flex-col items-start gap-[2rem] w-full max-[425px]:text-center max-[425px]:items-center p-[1rem]">
            <h1 class="lg:text-[48px] md:text-[38px] text-[28px] font-[600] md:font-[700] sm:font-[900] text-[#224C75] w-[70%]">Gain the skill you need to land a job in the tech industry</h1>
            ...
            <div>
                <img src="./images/three-female-and-male-in-second-section.svg" alt="">
            </div>
        </div>
        <div class="">
