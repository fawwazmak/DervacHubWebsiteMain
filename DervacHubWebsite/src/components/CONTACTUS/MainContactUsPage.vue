...
<div class="bg-white pb-3">
    ...
    <div class="grid lg:grid-cols-3 md:grid-cols-2 justify-between md:px-[10rem] gap-8 bg-white grid-cols-1">
        ...
        <div class="flex flex-col items-center text-center gap-4">
            ...
            <p class="text-[#101828] text-[20px]">Office</p>
            <p class="text-[#475467] text-[16px]">Come to so hello at our office.</p>
        ...
        <div class="flex flex-col items-center text-center gap-4">
            ...
            <p class="text-[#475467] text-[16px]">Mon-Fri from 8am to 5pm.</p>
